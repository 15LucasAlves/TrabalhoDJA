...
public class BossCombat : MonoBehaviour
{
    ...
    public float chaseRange = 15f; // Maior alcance de persegui��o
    ...
    private void Update()
    {
        ...
        // Rotacione em dire��o ao jogador, a menos que esteja atacando
    ...
    private IEnumerator PerformAttack()
    {
        if (animator == null)
        {
            Debug.LogWarning("Animator n�o est� atribu�do ao BossCombat.");
            yield break;
        }
