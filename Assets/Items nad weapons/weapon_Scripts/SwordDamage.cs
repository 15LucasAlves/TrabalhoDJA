...
public class SwordDamage : MonoBehaviour
{
    ...
    private Collider swordCollider; // Refer�ncia ao Collider da espada
    public CinemachineImpulseSource impulseSource;

    private void Awake()
    {
        // Obt�m o Collider da espada
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        // Verifica se o objeto atingido � um inimigo comum
        ...
        // Verifica se o objeto atingido � o chefe
    ...
    // M�todo p�blico para aplicar dano diretamente
